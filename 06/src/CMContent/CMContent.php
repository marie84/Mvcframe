    ...
    switch($action) {
      case 'install': 
        try {
          ...
          $this->db->ExecuteQuery(self::SQL('insert content'), array('home', 'page', 'New page', "This is a demo page, this could be your personal home-page.\n\nMvcframe is a PHP-based MVC-inspired Content management Framework, watch the making of Lydia, that Mvcframe is based on at: http://dbwebb.se/lydia/tutorial.", 'plain', $this->user['id']));
          $this->db->ExecuteQuery(self::SQL('insert content'), array('about', 'page', 'About page', "This is a demo page, this could be your personal about-page.\n\nMvcframe is used as a tool to educate in MVC frameworks.", 'plain', $this->user['id']));
		  $this->db->ExecuteQuery(self::SQL('insert content'), array('page', 'page', 'New page', "This is new page, this could be your personal new page.\n\n This is another line.",'plain', $this->user['id']));
