...
<tbody>
  <tr><td>Part of Mvcframe Core modules</td><td><?=$module['isMvcframeCore']?'Yes':'No'?></td></tr>
  <tr><td>Part of Mvcframe CMF modules</td><td><?=$module['isMvcframeCMF']?'Yes':'No'?></td></tr>
