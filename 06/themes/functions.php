...
function create_url($urlOrController=null, $method=null, $arguments=null) {
  return CMvcframe::Instance()->CreateUrl($urlOrController, $method, $arguments);
}
...
function theme_url($url) {
  return create_url(CMvcframe::Instance()->themeUrl . "/{$url}");
}
...
function theme_parent_url($url) {
  return create_url(CMvcframe::Instance()->themeParentUrl . "/{$url}");
}
