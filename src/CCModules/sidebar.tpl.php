...
<div class='box'>
<h4>Mvcframe core</h4>
<p>Mvcframe core modules.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if($module['isMvcframeCore']): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
...
<div class='box'>
<h4>Mvcframe CMF</h4>
<p>Mvcframe Content Management Framework (CMF) modules.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if($module['isMvcframeCMF']): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
...
<div class='box'>
<h4>More modules</h4>
<p>Modules that does not implement any specific Mvcframe interface.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if(!($module['isController'] || $module['isMvcframeCore'] || $module['isMvcframeCMF'])): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
